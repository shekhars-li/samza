...
public class StandaloneConfigBuilder extends ConfigBuilder {
  ...
  public StandaloneConfigBuilder(String jobName, String taskClass) {
    super(jobName, taskClass);
    jobCoordinatorFactory = STANDALONE_JOB_COORDINATOR_FACTORY;
    sspGrouperFactory = STANDALONE_SSP_GROUPER_FACTORY;
    taskNameGrouperFactory = STANDALONE_TASK_NAME_GROUPER_FACTORY;
  }
}
